...
<script>
// //update the member data list
// function getUsers(){
//     $.post("<?php echo base_url('member/listview/') ?>",function (data){
//         $('#userData').html(data);
//     });
// }
// //send crud request to the server-side script
...
//fill the user data in the  edit  form
...
//Action on modal show and hidden events
// $(function(){
...
//     });
    // $('#modalUserAddEdit').om('hidden.bs.modal',function(){
