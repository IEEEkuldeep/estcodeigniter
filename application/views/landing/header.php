...
">
            <a class="navbar-brand" href="/store/index.php/">Welcome Home</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <form class="form-inline mt-2 mt-md-0">
                    <a class="nav-link" href="/store/index.php/EmailController/login">Login<span
                            class="sr-only">(current)</span></a>
                    <a class="nav-link" href="/store/index.php/EmailController/signup">Signup<span
                            class="sr-only">(current)</span></a>
