                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/h4ind/assests/imagesimg/user/avatar-1.jpg" alt="Generic placeholder image">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/h4ind/assests/imagesimg/user/avatar-2.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="/h4ind/assests/imagesimg/user/avatar-3.jpg" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="/h4ind/assests/imagesimg/user/avatar-2.jpg" class="img-radius" alt="User-Profile-Image">
                                <span>John Doe</span>
                                <a href="../<?php base_url() ?>" class="dud-logout" title="Logout">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            <div class="table-responsive" >
                                                ...
                                                <thead>
                                                    ...
                                                    <tbody id="example1">
                                                        <!-- <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-1.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-2.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-3.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-4.jpg" alt="activity-user"></td>
                                                            <td>
                                                        ...
                                                        <tr class="unread">
                                                            <td><img class="rounded-circle" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-5.jpg" alt="activity-user"></td>
                                                            <td>
                                        ...
                                        <div class="tab-pane fade" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-1.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-2.jpg" alt="activity-user">Albert Andersen</h6>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-3.jpg" alt="activity-user">Silje Larsen</h6>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                            <table class="table table-hover" >
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-2.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">The quick brown fox</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-3.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">The quick brown fox</h6>
                                                        </td>
                                        ...
                                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-4.jpg" alt="activity-user">Silje Larsen</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Dog the quick brown</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-5.jpg" alt="activity-user">Ida Jorgensen</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">The quick brown fox</h6>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;" src="/h4ind/assests/imagesimg/user/avatar-4.jpg" alt="activity-user">Albert Andersen</h6>
                                                        </td>
                                                        <td>
                                                            <h6 class="m-0">Jumps over the lazy</h6>
                                                        </td>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('Admin/fetchDatafromDatabase'); ?>",
...
{ 
 ...
 $(document).on("click", ".delete", function() { 
	//alert("Success");
		...
		$.ajax({
			url: "<?php echo base_url("Admin/deleterecords");?>",
			type: "POST",
			cache: false,
			data:{
				type: 2,
	...
	//alert("Success");
		var $ele = $(this).parent().parent();
		$.ajax({
			url: "<?php echo base_url("Admin/doctorstatus");?>",
			type: "POST",
			cache: false,
			data:{
				type: 2,
