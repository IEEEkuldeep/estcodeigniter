...
function getUsers(){
    $.post( "http://localhost:/estcodeigniter/index.php/members/listView/", function( data ){
        $('#userData').html(data);
    });
}
...
function userAction(type, id){
    ...
    $.ajax({
        type: 'POST',
        url: 'http://localhost:/estcodeigniter/index.php/members/'+type,
        dataType: 'JSON',
        data: userData,
        beforeSend: function(){
...
function editUser(id){
    $.post( "http://localhost:/estcodeigniter/index.php/members/memData/", {id: id}, function( data ){
        $('#id').val(data.id);
